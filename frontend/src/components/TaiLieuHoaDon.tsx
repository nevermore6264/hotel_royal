...
function ghiChuHienThi(g: GiaoDichHoaDon): string {
...
const TaiLieuHoaDon = forwardRef<HTMLElement, Props>(function TaiLieuHoaDon(
  ...
  return (
    ...
    >
      ...
      <section className="invoice-section">
        <h2 className="invoice-section__title">Chi tiết phòng (kỳ lưu trú)</h2>
